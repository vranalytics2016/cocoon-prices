...
WEB_URL = "https://kannadatopnews.com/category/announcement/sericulture/silk-cocoon/"
HEADERS = {
...
def parse_feed():
    ...
    if len(items) == 0:
        try:
            ...
            article_urls = list(set(link_regex.findall(cat_html)))[:10]
...
def update_csv():
    ...
    if os.path.exists(CSV_FILE):
        ...
        if not new_df.empty:
            ...
            # Always create file with headers on first run
